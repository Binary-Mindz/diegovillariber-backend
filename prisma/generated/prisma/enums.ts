...
export const BattleCategory = {
  ...
  CLEAN_BUILD_BATTLE: 'CLEAN_BUILD_BATTLE',
  SLEEPER_BATTLE: 'SLEEPER_BATTLE',
  SOUND_BATTLE: 'SOUND_BATTLE',
  WHEELS_BATTLE: 'WHEELS_BATTLE',
  ENGINE_BAY_BATTLE: 'ENGINE_BAY_BATTLE',
  STREET_VS_TRACK_BATTLE: 'STREET_VS_TRACK_BATTLE',
  DAILY_HERO_BATTLE: 'DAILY_HERO_BATTLE',
  YOUNGTIMER_BATTLE: 'YOUNGTIMER_BATTLE',
  SUPER_HYPERCAR_BATTLE: 'SUPER_HYPERCAR_BATTLE',
  BRAND_CLASH_BATTLE: 'BRAND_CLASH_BATTLE',
  SIXTIES_ERA_BATTLE: 'SIXTIES_ERA_BATTLE',
  SEVENTIES_ERA_BATTLE: 'SEVENTIES_ERA_BATTLE',
  EIGHTIES_ERA_BATTLE: 'EIGHTIES_ERA_BATTLE',
  NINTIES_ERA_BATTLE: 'NINTIES_ERA_BATTLE',
  TWENTIES_ERA_BATTLE: 'TWENTIES_ERA_BATTLE',
  NIGHT_THEME_BATTLE: 'NIGHT_THEME_BATTLE',
  FUNNY_CAR_MOMENT: 'FUNNY_CAR_MOMENT',
  OTHER: 'OTHER'
} as const
